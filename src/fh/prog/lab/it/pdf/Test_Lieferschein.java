...
public class Test_Lieferschein {
    ...
    private static String strasseNr = "Goethestraﬂe 1";
    ...
    private static void fill(Document document) throws DocumentException {
        ...
        addEmptyLine(start, 1);
        //Hier muss noch eine Datenbank abfragen F‹R Adresse rein von fiku
        ...
        addEmptyLine(start, 1);
        start.add(new Paragraph("Dear" + "" + ",", normal));
        addEmptyLine(start, 1);
        start.add(new Paragraph("Attached you receive:", normal));
        addEmptyLine(start, 1);
        document.add(start);
        start.clear();
        //TABELE
